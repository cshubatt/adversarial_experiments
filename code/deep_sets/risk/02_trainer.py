# copy of garp/02_trainer.py, change y_var to theory
import os
import pdb
import sys
import numpy as np
...
if __name__ == '__main__':
    ...
    ddir = 'data_k{0}_nsim{1}_{2}/'.format(k, nsims, theory)
    odir = ddir + 'outfiles/'
    ...
    # Load dataset
    train = DataIterator(ddir+'train.csv', 128, shuffle=True)
    valid = DataIterator(ddir+'valid.csv', 128)
    test  = DataIterator(ddir+'test.csv', 128)
